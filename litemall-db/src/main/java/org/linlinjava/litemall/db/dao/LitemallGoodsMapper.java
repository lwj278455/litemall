...
public interface LitemallGoodsMapper {
     ...
     * @return
     */
    List<LitemallGoods> selectByDealSelective(@Param("example") LitemallGoodsExample example, @Param("selective") LitemallGoods.Column ... selective);

    List<LitemallGoods> selectByDealGoodSelective(@Param("goodsId")Integer goodsId, @Param("name") String  name,@Param("categoryIds") List<Integer> categoryIds);
    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table litemall_goods
     *
