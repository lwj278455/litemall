...
public class LitemallUser {
    ...
    private Integer  userIntegr;//用户积分

    public Integer getUserIntegr() {
        return userIntegr;
    }

    public void setUserIntegr(Integer userIntegr) {
        this.userIntegr = userIntegr;
    }
     ...
     *
     * @param unionid the value for litemall_user.session_key
     *
     * @mbg.generated
     */
    public void setunionid(String unionid) {
